...
describe('CreateBaZH', () => {
    it('CreateBaZH', () => {
        ...
        .click()
        cy.get('div.col-xs-6:nth-child(2) > div:nth-child(4) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(2) > ul:nth-child(1)').contains('Instituut').click()
        //choose Expert Team
